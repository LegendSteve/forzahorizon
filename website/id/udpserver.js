import { EventInterferer } from "./eventinterferer";
import dgram from "dgram";
class UdpServer extends EventInterferer {
    port;
    socket;
    connected = false;
    constructor(port) {
    ...
    start() {
        ...
        activeUdpServers[this.port] = this;
    }
}
let activeUdpServers = {};
export { activeUdpServers, UdpServer };
